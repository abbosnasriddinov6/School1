            ...
            <div className="my-10">
                <div>
                    ...
                    <div className="grid lg:grid-cols-3 sm:grid-cols-2  w-full mx-auto gap-5">
                        ...
                        <div className="px-5 flex flex-col-reverse sm:block py-3 bg-[#e5f3ff] rounded-3xl relative group">
                            <div className="group">
                                <FaMedal
                        ...
                        <div className="px-5 flex flex-col-reverse sm:block py-3 bg-[#fff7e5] rounded-3xl relative group">
                            <div className="group">
                                <FaClock
                        ...
                        <div className="px-5 flex flex-col-reverse sm:block py-3 bg-[#f3e5ff] rounded-3xl relative group">
                            <div className="group">
                                <TfiBlackboard
